...
TEST(QueueSelection, TheoreticalTest8) {
    ...
    const std::vector<VkQueueFamilyProperties> given_input = {
        {
            // This will be selected for graphics, compute, and transfer.
            .queueFlags = VK_QUEUE_GRAPHICS_BIT | VK_QUEUE_COMPUTE_BIT | VK_QUEUE_TRANSFER_BIT, // index 0
        },
        {
            // This will be selected for graphics, compute, and transfer.
...
TEST(QueueSelection, NVIDIA_GeForce_940M) {
    const QueueFamilyIndexCandidates expected_result = {
        0, // graphics
        0, // compute
        1, // transfer
...
TEST(QueueSelection, NVIDIA_GeForce_660M) {
    const QueueFamilyIndexCandidates expected_result = {
        0, // graphics
        0, // compute
        1, // transfer
...
TEST(QueueSelection, AMD_Radeon_7900_XTX) {
    const QueueFamilyIndexCandidates expected_result = {
        0, // graphics
        0, // compute
        2, // transfer
...
TEST(QueueSelection, Intel_ARC_A770) {
    const QueueFamilyIndexCandidates expected_result = {
        0, // graphics
        1, // compute
        2, // transfer
