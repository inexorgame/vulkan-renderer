...
template <>
VkBufferMemoryBarrier2 make_info(VkBufferMemoryBarrier2 info) {
...
template <>
VkCommandBufferInheritanceRenderingInfo make_info(VkCommandBufferInheritanceRenderingInfo info) {
...
template <>
VkImageMemoryBarrier2 make_info(VkImageMemoryBarrier2 info) {
