...
public:
    ...
    VkResult initialise(const VkDevice &device, const VmaAllocator &vma_allocator, const std::shared_ptr<VulkanDebugMarkerManager> debug_marker_manager);
    ...
    VkResult update_uniform_buffer(const std::string &internal_uniform_buffer_name, void *uniform_buffer_new_data_source,
