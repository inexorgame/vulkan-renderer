...
VulkanDebugUtilsCallback::VulkanDebugUtilsCallback(const Instance &inst,
    ...
    if (vkCreateDebugUtilsMessengerEXT == nullptr) {
        throw InexorException("Error: vkCreateDebugUtilsMessengerEXT was not found! Make sure to enable "
                              "VK_EXT_debug_utils instance extension (if available on the system)!");
    }
    if (vkDestroyDebugUtilsMessengerEXT == nullptr) {
        throw InexorException("Error: vkDestroyDebugUtilsMessengerEXT was not found! Make sure to enable "
                              "VK_EXT_debug_utils instance extension (if available on the system)!");
    }
    if (debug_callback == nullptr) {
        throw InexorException("Error: Parameter 'debug_callback' is invalid!");
    }
