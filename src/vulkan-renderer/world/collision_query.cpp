...
std::optional<RayCubeCollision<Cube>> ray_cube_collision_check(const Cube &cube, const glm::vec3 pos,
    ...
    // We need to pass this into glm::intersectRaySphere by reference although we are not interested into it
    ...
    // Note that this is much easier to calculate than a collision with a bounding box
