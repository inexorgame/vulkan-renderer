...
ModelCpuData::ModelCpuData(const wrapper::Device &device_wrapper, const ModelFile &model_file)
...
void ModelCpuData::load_textures(const wrapper::Device &device, const tinygltf::Model &model) {
...
void ModelCpuData::load_materials(const tinygltf::Model &model) {
...
ModelNode *ModelCpuData::find_node(ModelNode *parent, const std::uint32_t index) {
...
ModelNode *ModelCpuData::node_from_index(const std::uint32_t index) {
    ModelNode *node_found = nullptr;
...
void ModelCpuData::load_node(const wrapper::Device &device_wrapper, const tinygltf::Model &model, ModelNode *parent,
...
void ModelCpuData::load_skins(const tinygltf::Model &model) {
...
void ModelCpuData::load_nodes(const wrapper::Device &device_wrapper, const tinygltf::Model &model) {
...
void ModelCpuData::load_animations(const tinygltf::Model &model) {
