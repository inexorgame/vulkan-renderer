...
namespace vulkan_renderer {
	...
	class InexorDescriptorManager : public ManagerClassTemplate<InexorDescriptorPool>,
	                                public ManagerClassTemplate<InexorDescriptorBundle>
	{
		private:			
		...
		public:
			...
			VkResult create_descriptor_pool(const std::string& internal_descriptor_pool_name,
			...
			/// @param 
			/// @param 
			VkResult create_descriptor_bundle(const std::string& internal_descriptor_name,
			                                 std::shared_ptr<InexorDescriptorPool>& descriptor_pool,
            ...
            /// 
            /// 
			VkResult add_write_descriptor_set(std::shared_ptr<InexorDescriptorBundle> descriptor_bundle,
