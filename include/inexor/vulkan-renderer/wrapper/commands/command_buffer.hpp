...
public:
    ...
    const CommandBuffer &begin_secondary_command_buffer(
    ...
    const CommandBuffer &execute_secondary_command_buffers(std::span<const VkCommandBuffer> secondary_cmd_buffers) const;
