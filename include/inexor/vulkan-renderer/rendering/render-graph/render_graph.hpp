...
public:
    ...
    /// @warning A common mistake is to pass a lambda as ``OnCreateGraphicsPipeline`` function and referencing in the
    /// lambda whose a non-member local variable whose lifetime will have expired once the lambda is invoked!
